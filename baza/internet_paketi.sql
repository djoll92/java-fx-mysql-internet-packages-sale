...
CREATE TABLE `prodaja` (
  ...
  `brzina` varchar(45) NOT NULL,
  `protok` varchar(45) NOT NULL,
  `trajanje_ugovora` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `prodaja` VALUES (11,'Djordje','Marjanovic','Dositejeva 1','20 Mbit','Flat','2 godine');
...
-- Dump completed on 2018-01-12  1:31:00
